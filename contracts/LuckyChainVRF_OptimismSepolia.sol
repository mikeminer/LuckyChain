...
contract LuckyChainVRF_OptimismSepolia is VRFConsumerBaseV2 {
    // -------------------------
    // Types
    // -------------------------
    ...
    uint256 public constant TICKET_PRICE_USDC = 1_000_000; // 1 USDC with 6 decimals
        ...
        )
    {
        ...
        // USDC on Optimism Sepolia (6 decimals)
